...
echo "    ├── workflows/core/         (24 core workflows)"
...
echo "  • Workflows: 35 files (22 core + 12 execute-tasks phases + 1 meta)"
echo "  • Config: 1 file"
echo "  • Total: 37 files + CLAUDE.md"
echo ""
...
echo ""
echo "7. Quick tasks & bugs (lightweight, goes to backlog):"
