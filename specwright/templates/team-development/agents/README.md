...
**Or Manually**:
```bash
cp specwright/templates/team-development/agents/backend-dev-template.md \
...
- Check specwright/workflows/team/README.md for complete guide
