...
**Beispiel - GUT:**
```markdown
- [ ] FILE_EXISTS: specwright/templates/api-spec.md
...
**Datei**: `specwright/workflows/core/create-spec.md` (Step 2)
...
**Datei**: `specwright/workflows/core/create-spec.md` (Step 3)
...
**Datei**: `specwright/workflows/core/execute-tasks.md` (vor Step 6)
