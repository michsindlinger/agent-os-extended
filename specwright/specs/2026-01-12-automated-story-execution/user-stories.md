...
**Datei-Prüfungen:**
- [ ] FILE_EXISTS: specwright/docs/story-sizing-guidelines.md
...
**WO:**
- specwright/docs/story-sizing-guidelines.md
...
```bash
# Auto-Verify
test -f specwright/docs/story-sizing-guidelines.md && echo "FILE OK"
grep -q "Max-Größe" specwright/docs/story-sizing-guidelines.md && echo "CONTENT OK"
```
...
**Datei-Prüfungen:**
- [ ] FILE_EXISTS: specwright/templates/docs/user-stories-template.md (updated)
...
**WO:**
- specwright/templates/docs/user-stories-template.md
...
```bash
# Auto-Verify
grep -q "FILE_EXISTS:" specwright/templates/docs/user-stories-template.md && echo "FORMAT OK"
grep -q "Completion Check" specwright/templates/docs/user-stories-template.md && echo "SECTION OK"
```
...
**Datei-Prüfungen:**
- [ ] FILE_EXISTS: specwright/workflows/core/create-spec.md (updated)
...
**WO:**
- specwright/workflows/core/create-spec.md (Step 2)
...
```bash
# Auto-Verify
grep -q "STORY SIZING RULES" specwright/workflows/core/create-spec.md && echo "SIZING OK"
grep -q "FILE_EXISTS" specwright/workflows/core/create-spec.md && echo "FORMAT OK"
```
...
**WO:**
- specwright/workflows/core/create-spec.md (Step 3)
...
```bash
# Auto-Verify
grep -q "Completion Check" specwright/workflows/core/create-spec.md && echo "SECTION OK"
grep -q "Auto-Verify" specwright/workflows/core/create-spec.md && echo "VERIFY OK"
grep -q "Story ist DONE" specwright/workflows/core/create-spec.md && echo "DONE OK"
```
...
**Datei-Prüfungen:**
- [ ] FILE_EXISTS: specwright/workflows/core/execute-tasks.md (updated)
...
**WO:**
- specwright/workflows/core/execute-tasks.md (neuer Step 5.5)
...
```bash
# Auto-Verify
grep -q "mcp_tool_check\|Step 5.5" specwright/workflows/core/execute-tasks.md && echo "STEP OK"
grep -q "BLOCKED" specwright/workflows/core/execute-tasks.md && echo "BLOCKING OK"
```
...
**Datei-Prüfungen:**
- [ ] FILE_EXISTS: specwright/docs/mcp-setup-guide.md
...
**WO:**
- specwright/docs/mcp-setup-guide.md
...
```bash
# Auto-Verify
test -f specwright/docs/mcp-setup-guide.md && echo "FILE OK"
grep -q "Playwright" specwright/docs/mcp-setup-guide.md && echo "PLAYWRIGHT OK"
grep -q ".mcp.json" specwright/docs/mcp-setup-guide.md && echo "CONFIG OK"
```
...
**Inhalt-Prüfungen:**
- [ ] CONTAINS: setup.sh enthält "specwright/docs/story-sizing-guidelines.md"
- [ ] CONTAINS: setup.sh enthält "specwright/docs/mcp-setup-guide.md"
- [ ] CONTAINS: setup.sh enthält "mkdir -p specwright/docs"
...
**DoD (Definition of Done):**
- [ ] mkdir für specwright/docs hinzugefügt
...
**WIE:**
- Neuen mkdir-Befehl: `mkdir -p specwright/docs`
...
grep -q "specwright/docs" setup.sh && echo "DOCS DIR OK"
```
