...
> Spec: @specwright/specs/2026-01-12-anthropic-skills-format-migration/spec.md
> Created: 2026-01-12
...
- **Description:** Created migration script and migrated generic skill templates:
  - Created: specwright/scripts/migrate-skills-format.sh
...
- Migration script: `specwright/scripts/migrate-skills-format.sh`
