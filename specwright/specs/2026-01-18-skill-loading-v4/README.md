...
```
specwright/workflows/core/execute-tasks/
...
| Test Automation | specwright/skills/qa-test-automation.md | Unit Tests |
```
...
- specwright/skills/backend-logic-implementing.md  ← Load completely
- specwright/skills/qa-test-automation.md          ← Load completely
...
- **Workflow Docs**: `specwright/workflows/core/execute-tasks/`
