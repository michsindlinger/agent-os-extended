...
> Created: 2025-12-27
> Parent Spec: @specwright/specs/2025-12-27-product-launch-framework/spec.md

## Architecture Overview

The Market Validation System follows Specwright's established patterns:
...
User → /validate-market command
  ↓
specwright/workflows/validation/validate-market.md (orchestrator)
  ↓
Delegates to 5 specialist agents sequentially:
  ...
  ↓
Outputs to specwright/market-validation/YYYY-MM-DD-product-name/
```

## Reusable Components (From Codebase Analysis)

### 1. Workflow Patterns
**Source**: `specwright/workflows/core/create-spec-v2.md`, `execute-tasks.md`
...
- ✅ `@specwright/` file path convention
...
### 3. Template System
**Source**: `specwright/templates/research/`, `specwright/templates/verification/`
...
### 4. Skills System
**Source**: `specwright/skills/base/`, `specwright/skills/java/`, etc.
...
**Source**: `specwright/workflows/verification/`, `specwright/templates/verification/`
...
<step number="4" subagent="file-creator" name="workspace_creation">
  ...
  Create: specwright/market-validation/YYYY-MM-DD-product-name/
</step>
...
<step number="0" name="market_validation_check">
  ...
  IF validated:
    LOAD: @specwright/market-validation/[latest]/validation-results.md
...
### Distribution
- **GitHub**: Push to specwright repository
- **Setup Scripts**: Users download via setup.sh + setup-claude-code.sh
- **Documentation**: README.md + specwright/workflows/validation/README.md
...
- No breaking changes to Specwright core
