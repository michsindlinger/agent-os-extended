...
**Location**: `specwright/skills/product/product-strategy-patterns.md`
...
- [ ] File saved in `specwright/skills/product/`
...
**Location**: `specwright/skills/business/market-research-best-practices.md`
...
- [ ] File saved in `specwright/skills/business/`
...
**Location**: `specwright/skills/business/business-analysis-methods.md`
...
**Location**: `specwright/skills/business/validation-strategies.md`
...
**Location**: `specwright/skills/marketing/content-writing-best-practices.md`
...
**Location**: `specwright/skills/marketing/seo-optimization-patterns.md`
...
**Location**: `specwright/templates/market-validation/competitor-analysis.md`
...
**Location**: `specwright/templates/market-validation/market-positioning.md`
...
**Location**: `specwright/templates/market-validation/validation-plan.md`
...
**Location**: `specwright/templates/market-validation/ad-campaigns.md`
...
**Location**: `specwright/templates/market-validation/analytics-setup.md`
...
**Location**: `specwright/templates/market-validation/validation-results.md`
...
**Location**: `specwright/workflows/validation/validate-market.md`
...
- [ ] File path conventions follow `@specwright/` pattern
...
**Location**: `.claude/commands/specwright/validate-market.md`

**Deliverables**:
- Command title and description
- Version note (Phase A)
- Reference to workflow: `@specwright/workflows/validation/validate-market.md`
...
### Task 5.2: Update specwright/config.yml
**Effort**: 1.5h
**Priority**: HIGH
**Dependencies**: None

**Location**: `specwright/config.yml`
...
**Modifications**:
- Create `specwright/skills/business/` directory
- Create `specwright/skills/marketing/` directory
- Create `specwright/templates/market-validation/` directory
...
mkdir -p specwright/skills/business
mkdir -p specwright/skills/marketing

download_file "$REPO_URL/specwright/skills/business/market-research-best-practices.md" \
  "specwright/skills/business/market-research-best-practices.md"
download_file "$REPO_URL/specwright/skills/business/business-analysis-methods.md" \
  "specwright/skills/business/business-analysis-methods.md"
download_file "$REPO_URL/specwright/skills/business/validation-strategies.md" \
  "specwright/skills/business/validation-strategies.md"
download_file "$REPO_URL/specwright/skills/marketing/content-writing-best-practices.md" \
  "specwright/skills/marketing/content-writing-best-practices.md"
download_file "$REPO_URL/specwright/skills/marketing/seo-optimization-patterns.md" \
...
- Download validate-market command to `.claude/commands/specwright/`
...
download_file "$REPO_URL/.claude/commands/specwright/validate-market.md" \
  ".claude/commands/specwright/validate-market.md"
...
if [ "$CREATE_SYMLINKS" = true ]; then
  ...
  ln -sf "$(pwd)/specwright/skills/business/market-research-best-practices.md" \
    ".claude/skills/business/market-research-best-practices.md"
  ln -sf "$(pwd)/specwright/skills/business/business-analysis-methods.md" \
    ".claude/skills/business/business-analysis-methods.md"
  ln -sf "$(pwd)/specwright/skills/business/validation-strategies.md" \
    ".claude/skills/business/validation-strategies.md"
  ln -sf "$(pwd)/specwright/skills/marketing/content-writing-best-practices.md" \
    ".claude/skills/marketing/content-writing-best-practices.md"
  ln -sf "$(pwd)/specwright/skills/marketing/seo-optimization-patterns.md" \
...
# Deploy landing page
cd specwright/market-validation/YYYY-MM-DD-product-name/landing-page
netlify deploy --prod
...
For complete guide, see: [Market Validation Guide](specwright/workflows/validation/README.md)
```
...
### Task 7.2: Create specwright/workflows/validation/README.md
**Effort**: 1-1.5h
**Priority**: HIGH
**Dependencies**: All implementation tasks

**Location**: `specwright/workflows/validation/README.md`
...
- Verify each step executes:
  ...
  4. Workspace created in specwright/market-validation/
