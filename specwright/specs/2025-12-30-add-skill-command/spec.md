...
> Created: 2025-12-30
> Research: @specwright/specs/2025-12-30-add-skill-command/research-notes.md
> Version: 1.0
> Status: Planning
...
Each type uses corresponding template from `specwright/templates/skills/`
...
Step-by-step:
1. Load base template from `specwright/templates/skills/[type]-template.md`
...
Priority order:
1. **specwright/config.yml**: Check `project.name` field
...
**File**: `.claude/commands/specwright/add-skill.md`
...
**File**: `specwright/workflows/skill/add-skill.md`
...
- **Tasks**: @specwright/specs/2025-12-30-add-skill-command/tasks.md
- **Research Notes**: @specwright/specs/2025-12-30-add-skill-command/research-notes.md
- **Technical Specification**: @specwright/specs/2025-12-30-add-skill-command/sub-specs/technical-spec.md
