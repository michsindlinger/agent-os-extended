...
These are the tasks to be completed for the spec detailed in @specwright/specs/2025-12-30-add-skill-command/spec.md
...
- [x] Create `.claude/commands/specwright/add-skill.md` command file
...
- [x] Test command registration with Specwright Manager

### 1.2 Workflow File Creation
- [x] Create `specwright/workflows/skill/add-skill.md` workflow file
...
- [x] Create `specwright/workflows/skill/utils/detect-backend.md` utility
...
- [x] Create `specwright/workflows/skill/utils/detect-frontend.md` utility
...
- [x] Create `specwright/workflows/skill/utils/detect-testing.md` utility
...
- [x] Create `specwright/workflows/skill/utils/detect-cicd.md` utility
...
- [x] Review Explore agent capabilities in `specwright/workflows/utils/explore.md`
...
- [x] Create `specwright/workflows/skill/analysis/discover-api-patterns.md`
...
- [x] Create `specwright/workflows/skill/analysis/discover-component-patterns.md`
...
- [x] Create `specwright/workflows/skill/analysis/discover-testing-patterns.md`
...
- [x] Create `specwright/workflows/skill/analysis/discover-deployment-patterns.md`
...
- [x] Create `specwright/workflows/skill/utils/extract-patterns.md`
...
- [x] Create `specwright/workflows/skill/validation/best-practices/` directory
...
- [x] Create `specwright/workflows/skill/validation/compare-patterns.md`
...
- [x] Create `specwright/workflows/skill/validation/generate-improvements.md`
...
- [x] Create `specwright/workflows/skill/validation/create-report.md`
...
- [x] Create `specwright/workflows/skill/interactive/present-improvements.md`
...
- [x] Create `specwright/workflows/skill/interactive/apply-improvements.md`
...
- [x] Create `specwright/workflows/skill/best-practices/framework-selection.md`
...
- [x] Create `specwright/workflows/skill/validation/best-practices/spring-boot.md`
...
- [x] Create `specwright/workflows/skill/validation/best-practices/express.md`
...
- [x] Create `specwright/workflows/skill/validation/best-practices/react.md`
...
- [x] Create `specwright/workflows/skill/validation/best-practices/angular.md`
...
- [x] Create `specwright/workflows/skill/validation/best-practices/playwright.md`
...
- [x] Create `specwright/workflows/skill/validation/best-practices/github-actions.md`
...
- [x] Create `specwright/templates/skills/` directory structure
...
- [x] Create `specwright/workflows/skill/utils/parse-template.md`
...
- [x] Create `specwright/workflows/skill/utils/replace-markers.md`
...
### 8.1 Specwright Config Detection
- [x] Create `specwright/workflows/skill/utils/detect-project-name.md`
- [x] Check for `specwright/config.yml` file
...
- [x] Save to specwright/config.yml for future use
...
- [x] Create `specwright/workflows/skill/utils/generate-frontmatter.md`
...
- [x] Create `specwright/workflows/skill/utils/assemble-skill.md`
...
- [x] Create `specwright/workflows/skill/interactive/preview-skill.md`
...
- [x] Display success message:
  ...
  - [x] Show next steps
- [x] Log operation to Specwright activity log
...
- [ ] Command registered and discoverable in Specwright Manager
