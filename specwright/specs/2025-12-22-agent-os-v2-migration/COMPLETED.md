# Specwright v2.0 Migration - COMPLETED
...
- ✅ 3. Update Setup Scripts
  ...
  - ✅ Commands install to .claude/commands/specwright/
...
- ✅ 5. Migrate Specwright Repository
...
**Commits:**
- `6cdba99` - Migrate to Specwright v2.0
...
- ✅ 6. Implement Profile System
  - ✅ Profile structure created (specwright/profiles/)
...
- ✅ 7. Implement Claude Skills System
  - ✅ Skills structure created (specwright/skills/)
  - ✅ 11 skills created:
...
1. `6cdba99` - Migrate to Specwright v2.0 (Phase I)
...
**After v2.0**:
- Visible `specwright/` directory (better discoverability)
...
This migration implements selected features from [Specwright 2.0](https://buildermethods.com/specwright/version-2) by Builder Methods, adapted for project-level installation with enterprise extensions.

**Key Adaptations**:
- Maintained project-level installation (vs central `~/specwright`)
...
Specwright v2.0 is now production-ready with:
