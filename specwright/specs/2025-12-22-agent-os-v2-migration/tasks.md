...
- [ ] 1. Create Migration Script (update-to-v2.sh)
  ...
  - [ ] 1.4 Implement directory renaming (.specwright → specwright)
  - [ ] 1.5 Implement workflows rename (instructions → workflows)
  - [ ] 1.6 Implement command isolation (.claude/commands/specwright/)
  - [ ] 1.7 Implement reference updates (@.specwright/ → @specwright/)
...
- [ ] 3. Update Setup Scripts
  ...
  - [ ] 3.4 Update paths to use specwright/ and workflows/
  - [ ] 3.5 Update command installation to .claude/commands/specwright/
...
- [ ] 5. Migrate Specwright Repository
  - [ ] 5.1 Run migration script on specwright repo
...
- [ ] 6. Implement Profile System
  ...
  - [ ] 6.2 Create profile directory structure (specwright/profiles/)
  ...
  - [ ] 6.7 Implement profile configuration (specwright/config.yml)
...
- [ ] 7. Implement Claude Skills System
  ...
  - [ ] 7.2 Create skills directory structure (specwright/skills/)
  ...
  - [ ] 7.10 Create symlinks in .claude/skills/ to specwright/skills/
