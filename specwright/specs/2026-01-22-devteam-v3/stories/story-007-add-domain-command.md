...
- [ ] FILE_EXISTS: specwright/workflows/core/add-domain.md
- [ ] FILE_EXISTS: .claude/commands/specwright/add-domain.md

### Inhalt-Prüfungen

- [ ] CONTAINS: specwright/workflows/core/add-domain.md enthält "domain-"
- [ ] CONTAINS: specwright/workflows/core/add-domain.md enthält "process.md"
- [ ] CONTAINS: specwright/workflows/core/add-domain.md enthält "Domain Areas"
- [ ] CONTAINS: .claude/commands/specwright/add-domain.md enthält "@specwright/workflows/core/add-domain.md"
...
**WO:**
- specwright/workflows/core/add-domain.md (neu)
- .claude/commands/specwright/add-domain.md (neu)
...
test -f specwright/workflows/core/add-domain.md && echo "Workflow OK"

# Verify command exists
test -f .claude/commands/specwright/add-domain.md && echo "Command OK"

# Verify workflow references domain structure
grep -q "domain-" specwright/workflows/core/add-domain.md && echo "Domain reference OK"
grep -q "process.md" specwright/workflows/core/add-domain.md && echo "Process template reference OK"
```
