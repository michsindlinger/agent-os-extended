...
- [ ] FILE_EXISTS: specwright/workflows/core/add-learning.md
- [ ] FILE_EXISTS: .claude/commands/specwright/add-learning.md

### Inhalt-Prüfungen

- [ ] CONTAINS: specwright/workflows/core/add-learning.md enthält "dos-and-donts.md"
- [ ] CONTAINS: specwright/workflows/core/add-learning.md enthält "AskUserQuestion"
- [ ] CONTAINS: .claude/commands/specwright/add-learning.md enthält "@specwright/workflows/core/add-learning.md"
...
**WO:**
- specwright/workflows/core/add-learning.md (neu)
- .claude/commands/specwright/add-learning.md (neu)
...
test -f specwright/workflows/core/add-learning.md && echo "Workflow OK"

# Verify command exists
test -f .claude/commands/specwright/add-learning.md && echo "Command OK"

# Verify workflow references dos-and-donts
grep -q "dos-and-donts.md" specwright/workflows/core/add-learning.md && echo "dos-and-donts reference OK"
```
