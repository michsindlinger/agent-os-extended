...
Scenario: setup-devteam-global.sh installiert v3.0 Templates
  ...
  And existiert ~/.specwright/templates/skills/backend/rails/Skill.md
  And existiert ~/.specwright/templates/skills/quality-gates/Skill.md
  And existiert ~/.specwright/templates/skills/domain/Skill.md
```
...
Scenario: Keine alten Agent Templates
  Given ich führe setup-devteam-global.sh aus
  When das Script abgeschlossen ist
  Then existiert NICHT ~/.specwright/templates/agents/dev-team/
```
...
Scenario: Neue Commands verfügbar
  ...
  When das Script abgeschlossen ist
  Then existiert .claude/commands/specwright/add-learning.md
  And existiert .claude/commands/specwright/add-domain.md
```
...
# rm -rf ~/.specwright/templates/agents/dev-team/
```
