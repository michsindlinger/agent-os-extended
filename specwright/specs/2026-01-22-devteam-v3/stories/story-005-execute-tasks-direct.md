...
- [ ] FILE_EXISTS: specwright/workflows/core/execute-tasks.md (aktualisiert)

### Inhalt-Prüfungen

- [ ] NOT_CONTAINS: specwright/workflows/core/execute-tasks.md enthält "dev-team__backend-developer"
- [ ] NOT_CONTAINS: specwright/workflows/core/execute-tasks.md enthält "dev-team__frontend-developer"
- [ ] NOT_CONTAINS: specwright/workflows/core/execute-tasks.md enthält "DELEGATE via Task tool"
- [ ] NOT_CONTAINS: specwright/workflows/core/execute-tasks.md enthält "extract_skill_patterns"
- [ ] CONTAINS: specwright/workflows/core/execute-tasks.md enthält "self_review"
- [ ] CONTAINS: specwright/workflows/core/execute-tasks.md enthält "self_learning_check"
- [ ] CONTAINS: specwright/workflows/core/execute-tasks.md enthält "dos-and-donts.md"
...
**WO:**
- specwright/workflows/core/execute-tasks.md (Phase 3 überschreiben)
...
! grep -q "dev-team__backend-developer" specwright/workflows/core/execute-tasks.md && echo "No backend agent OK"
! grep -q "dev-team__frontend-developer" specwright/workflows/core/execute-tasks.md && echo "No frontend agent OK"

# Verify new steps exist
grep -q "self_review" specwright/workflows/core/execute-tasks.md && echo "Self-review OK"
grep -q "self_learning_check" specwright/workflows/core/execute-tasks.md && echo "Self-learning OK"
```
