...
Scenario: Kontext wird aus Projekt-Dokumenten extrahiert
  Given specwright/product/tech-stack.md existiert mit Angular 18
  And specwright/product/architecture-decision.md existiert
...
Scenario: Design System wird in Frontend Skills integriert
  Given specwright/product/design-system.md existiert
  And specwright/product/ux-patterns.md existiert
...
Scenario: Graceful handling bei fehlenden Dokumenten
  Given specwright/product/design-system.md existiert NICHT
  When /build-development-team einen Frontend Skill erstellt
  Then enthält der Skill einen Hinweis "Not defined - see specwright/product/design-system.md"
...
- [ ] FILE_EXISTS: specwright/workflows/core/build-development-team.md (aktualisiert)
- [ ] FILE_EXISTS: .claude/commands/specwright/build-development-team.md (aktualisiert)

### Inhalt-Prüfungen

- [ ] CONTAINS: specwright/workflows/core/build-development-team.md enthält "version: 3.0"
- [ ] CONTAINS: specwright/workflows/core/build-development-team.md enthält ".claude/skills/"
- [ ] CONTAINS: specwright/workflows/core/build-development-team.md enthält "tech-stack.md"
- [ ] CONTAINS: specwright/workflows/core/build-development-team.md enthält "architecture-decision.md"
- [ ] CONTAINS: specwright/workflows/core/build-development-team.md enthält "design-system.md"
- [ ] CONTAINS: specwright/workflows/core/build-development-team.md enthält "ux-patterns.md"
- [ ] NOT_CONTAINS: specwright/workflows/core/build-development-team.md enthält ".claude/agents/dev-team/"
- [ ] NOT_CONTAINS: specwright/workflows/core/build-development-team.md enthält "skill-index.md"
...
- [ ] Erstellt Skills in .claude/skills/ (nicht specwright/skills/)
...
- Alle Skills nutzen Templates aus specwright/templates/skills/

**Kontext-Extraktion (NEU):**
Der Workflow MUSS folgende Dateien lesen und Informationen extrahieren:

1. **specwright/product/tech-stack.md** → Für ALLE Skills
   - Framework-Versionen
   - Libraries und Dependencies
   - Testing Frameworks
   - Build Tools

2. **specwright/product/architecture-decision.md** → Für ALLE Tech-Skills
   - Service Layer Patterns
   - API Design Patterns
   - Data Access Patterns
   - Error Handling Patterns

3. **specwright/product/architecture-structure.md** → Für ALLE Tech-Skills
   - Ordnerstruktur
   - Naming Conventions
   - File Organization

4. **specwright/product/design-system.md** → NUR für Frontend-Skills
   - Colors
   - Typography
   - Spacing
   - Component Patterns

5. **specwright/product/ux-patterns.md** → NUR für Frontend-Skills
   - Navigation Patterns
   - User Flows
...
- Platzhalter mit "Not defined - see specwright/product/[filename].md" ersetzen
- Warnung ausgeben dass Datei fehlt

**WO:**
- specwright/workflows/core/build-development-team.md (überschreiben)
- .claude/commands/specwright/build-development-team.md (aktualisieren)
...
grep -q "version: 3.0" specwright/workflows/core/build-development-team.md && echo "Version OK"

# Verify no agent references
! grep -q ".claude/agents/dev-team" specwright/workflows/core/build-development-team.md && echo "No agents OK"

# Verify skill path
grep -q ".claude/skills/" specwright/workflows/core/build-development-team.md && echo "Skill path OK"
```
