...
Siehe: Stories in `specwright/specs/2026-01-22-devteam-v3/stories/`
...
1. **Skill Templates** (in `specwright/templates/skills/`)
...
- [ ] **Integration Test 1:** Skill Template Validierung
   - Command: `ls -la specwright/templates/skills/frontend/angular/ | wc -l`
...
- Stories: @specwright/specs/2026-01-22-devteam-v3/stories/
