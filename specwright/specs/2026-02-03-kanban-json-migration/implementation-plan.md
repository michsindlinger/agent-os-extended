...
- [x] `specwright/templates/schemas/backlog-schema.json`
- [x] `specwright/templates/schemas/execution-kanban-schema.json`
- [x] `specwright/templates/schemas/spec-kanban-schema.json`

### 1.2 TypeScript Interface Dokumentation
- [ ] `specwright/docs/schemas/kanban-types.md` - Referenzdokumentation (optional, types in schema files)

### 1.3 Template Files erstellen
- [x] `specwright/templates/json/backlog-template.json`
- [x] `specwright/templates/json/execution-kanban-template.json`
- [x] `specwright/templates/json/spec-kanban-template.json`
...
- [x] `specwright/workflows/core/add-bug.md` - JSON statt MD (v3.0)
...
- [x] `specwright/workflows/core/add-todo.md` - JSON statt MD (v2.0)
- [x] Step 1: backlog.json laden/erstellen
- [x] Step 5: In backlog.json schreiben statt story-index.md

### 2.3 Backlog Story-Index Template aktualisieren
- [ ] `specwright/templates/docs/backlog-story-index-template.md` → Optional: View-Only oder entfernen
...
- [x] `specwright/workflows/core/create-spec.md` - kanban.json statt kanban-board.md (v3.3)
- [x] Kanban-Generierung auf JSON umstellen

### 3.2 Workflow: /add-story anpassen
- [x] `specwright/workflows/core/add-story.md` - JSON Update (v2.0)
- [x] Step 6: kanban.json statt kanban-board.md

### 3.3 Kanban Template aktualisieren
- [ ] `specwright/templates/docs/kanban-board-template.md` → Entfernen oder deprecaten (backward compat)
...
- [x] `specwright/workflows/core/execute-tasks/entry-point.md` (v4.0)
