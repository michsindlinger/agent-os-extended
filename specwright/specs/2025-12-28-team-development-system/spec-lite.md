...
> Full Spec: @specwright/specs/2025-12-28-team-development-system/spec.md
...
- **Workflow**: Extends `specwright/workflows/core/execute-tasks.md`
...
- **Config**: team_system section in specwright/config.yml
...
For complete details, see: @specwright/specs/2025-12-28-team-development-system/spec.md
