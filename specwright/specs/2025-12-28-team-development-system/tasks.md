...
**Location**: `specwright/skills/base/testing-best-practices.md`
...
**Location**: `specwright/skills/base/devops-patterns.md`
...
**Location**: `specwright/workflows/core/execute-tasks.md`
...
### Task 5.1: Update specwright/config.yml
**Effort**: 1h
**Priority**: HIGH
**Dependencies**: None
...
# Create directories
mkdir -p ~/.specwright/skills/base
...
download_file "$REPO_URL/specwright/skills/base/testing-best-practices.md" ~/.specwright/skills/base/testing-best-practices.md "skill"
download_file "$REPO_URL/specwright/skills/base/devops-patterns.md" ~/.specwright/skills/base/devops-patterns.md "skill"
...
ln -sf ~/.specwright/skills/base/testing-best-practices.md ~/.claude/skills/testing-best-practices.md
ln -sf ~/.specwright/skills/base/devops-patterns.md ~/.claude/skills/devops-patterns.md
...
mkdir -p specwright/team-deliverables
...
**Learn More**: See specwright/workflows/team/README.md
```
...
**Location**: `specwright/workflows/team/README.md` (NOTE: Workflow doesn't exist yet - this is a guide)
