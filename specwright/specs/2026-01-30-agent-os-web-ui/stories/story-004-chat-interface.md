...
- [ ] FILE_EXISTS: specwright-ui/ui/src/views/chat-view.ts
- [ ] FILE_EXISTS: specwright-ui/ui/src/components/chat-message.ts
- [ ] FILE_EXISTS: specwright-ui/ui/src/components/tool-call-badge.ts
- [ ] FILE_EXISTS: specwright-ui/src/server/claude-handler.ts
...
```bash
# Verify files exist
test -f specwright-ui/src/server/claude-handler.ts && echo "OK: claude-handler.ts exists"
test -f specwright-ui/ui/src/views/chat-view.ts && echo "OK: chat-view.ts exists"
test -f specwright-ui/ui/src/components/chat-message.ts && echo "OK: chat-message.ts exists"
test -f specwright-ui/ui/src/components/tool-call-badge.ts && echo "OK: tool-call-badge.ts exists"

# Verify Agent SDK usage
grep -q "query" specwright-ui/src/server/claude-handler.ts && echo "OK: Uses Agent SDK query"

# Verify streaming support
grep -q "stream" specwright-ui/ui/src/components/chat-message.ts && echo "OK: Streaming support"

# Verify Lit component
grep -q "@customElement" specwright-ui/ui/src/views/chat-view.ts && echo "OK: Lit component"
