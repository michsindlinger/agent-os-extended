...
- [ ] FILE_EXISTS: specwright-ui/package.json
- [ ] FILE_EXISTS: specwright-ui/src/server/index.ts
- [ ] FILE_EXISTS: specwright-ui/src/server/websocket.ts
...
- [ ] BUILD_PASS: cd specwright-ui && npm run build:backend
...
test -f specwright-ui/package.json && echo "OK: package.json exists"
test -f specwright-ui/src/server/index.ts && echo "OK: index.ts exists"
test -f specwright-ui/src/server/websocket.ts && echo "OK: websocket.ts exists"

# Verify dependencies in package.json
grep -q "express" specwright-ui/package.json && echo "OK: express dependency"
grep -q "ws" specwright-ui/package.json && echo "OK: ws dependency"
grep -q "@anthropic-ai/claude-agent-sdk" specwright-ui/package.json && echo "OK: agent-sdk dependency"

# Build check
cd specwright-ui && npm run build:backend && echo "OK: Backend builds"
```
