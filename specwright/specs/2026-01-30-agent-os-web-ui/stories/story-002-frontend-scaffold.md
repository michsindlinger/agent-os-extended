...
Scenario: Vite Dev Server startet
  Given ich bin im specwright-ui Projektordner
...
- [ ] FILE_EXISTS: specwright-ui/ui/package.json
- [ ] FILE_EXISTS: specwright-ui/ui/src/main.ts
- [ ] FILE_EXISTS: specwright-ui/ui/src/app.ts
- [ ] FILE_EXISTS: specwright-ui/ui/src/styles/theme.css

### Inhalt-Prüfungen

- [ ] CONTAINS: ui/package.json enthält "lit"
- [ ] CONTAINS: ui/package.json enthält "vite"
- [ ] CONTAINS: theme.css enthält "Space Grotesk"

### Funktions-Prüfungen

- [ ] BUILD_PASS: cd specwright-ui/ui && npm run build
- [ ] LINT_PASS: cd specwright-ui/ui && npm run lint
...
test -f specwright-ui/ui/package.json && echo "OK: ui/package.json exists"
test -f specwright-ui/ui/src/main.ts && echo "OK: main.ts exists"
test -f specwright-ui/ui/src/app.ts && echo "OK: app.ts exists"
test -f specwright-ui/ui/src/styles/theme.css && echo "OK: theme.css exists"

# Verify dependencies
grep -q "lit" specwright-ui/ui/package.json && echo "OK: lit dependency"
grep -q "vite" specwright-ui/ui/package.json && echo "OK: vite dependency"

# Verify theme contains required fonts
grep -q "Space Grotesk" specwright-ui/ui/src/styles/theme.css && echo "OK: Space Grotesk font"

# Build check
cd specwright-ui/ui && npm run build && echo "OK: UI builds"
```
