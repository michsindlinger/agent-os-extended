# Specwright Web UI - Specification
...
1. **Funktionierendes Repo:** `specwright-ui/` mit npm start
...
cd specwright-ui && npm run start:backend &
sleep 3 && curl -s http://localhost:3001/health | grep -q "ok"

# Frontend builds without errors
cd specwright-ui && npm run build
