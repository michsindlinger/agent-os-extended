...
These are the tasks to be completed for the spec detailed in @specwright/specs/2025-12-29-specwright-manager-gui/spec.md

> Created: 2025-12-29
> Status: ✅ MVP Complete (Phases 1-10)
> Implementation Branch: specwright-manager-gui
...
- [ ] Create new directory: `specwright-manager/`
...
- [ ] Implement function to get global Specwright path (`~/.specwright/`)
- [ ] Implement function to detect current project root (search for `.specwright/` or `specwright/`)
- [ ] Implement function to get project Specwright path
...
- [ ] Create section to display global Specwright path
...
- [ ] Test getting global Specwright path
