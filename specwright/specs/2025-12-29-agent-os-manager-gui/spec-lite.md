# Specwright Manager GUI - Spec Summary

> Quick reference for the Specwright Manager GUI specification
> Full spec: @specwright/specs/2025-12-29-specwright-manager-gui/spec.md

## What

Desktop GUI application (Electron) for managing Specwright components with visual distinction between global and project-specific overrides.
...
Technical developers who want visual management of Specwright components
