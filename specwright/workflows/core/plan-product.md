...
<delegation>
  ...
  - Product Brief Lite: specwright/product/product-brief-lite.md
  ...
  6. Write to specwright/product/tech-stack.md

  Use hybrid template lookup:
  - TRY: specwright/templates/product/tech-stack-template.md
  - FALLBACK: ~/.specwright/templates/product/tech-stack-template.md"
...
<conditional_logic>
  IF user_choice = YES:
    ...
    - Global Standards: ~/.specwright/standards/code-style.md, best-practices.md
...
<conditional_logic>
  IF user_choice = 1 (URL) OR 2 (Screenshots):
    ...
    [IF Screenshots:] Screenshots in specwright/design/screenshots/
    ...
    4. Write to: specwright/product/design-system.md
    5. If screenshots: Copy to specwright/product/design/screenshots/

    Templates (hybrid lookup):
    - TRY: specwright/templates/product/design-system-template.md
    - FALLBACK: ~/.specwright/templates/product/design-system-template.md
...
<delegation>
  ...
  Context:
  - Product Brief: specwright/product/product-brief.md
  - Tech Stack: specwright/product/tech-stack.md (check if frontend exists)
  - Design System: specwright/product/design-system.md (if exists)
  ...
  6. Write to: specwright/product/ux-patterns.md

  Templates (hybrid lookup):
  - TRY: specwright/templates/product/ux-patterns-template.md
  - FALLBACK: ~/.specwright/templates/product/ux-patterns-template.md
...
<delegation>
  ...
  7. Write to specwright/product/architecture-decision.md

  Use hybrid template lookup:
  - TRY: specwright/templates/product/architecture-decision-template.md
  - FALLBACK: ~/.specwright/templates/product/architecture-decision-template.md
