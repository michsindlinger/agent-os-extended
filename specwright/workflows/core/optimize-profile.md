...
<mandatory_actions>
  ...
  3. CREATE output folder structure:
     ```
     .specwright/profile-optimization/
  ...
  6. PRESENT output to user:
     ...
     **Speicherort:** .specwright/profile-optimization/[YYYY-MM-DD-project-name]/
...
1. Projekt-lokal: `specwright/templates/profile-optimization/`
2. Global: `~/.specwright/templates/profile-optimization/`
