...
<detection_logic>
  ...
  IF specwright/product/platform-brief.md EXISTS:
    ...
    LOAD: specwright/product/platform-brief.md
    LOAD: specwright/product/roadmap/platform-roadmap.md (REQUIRED)
    LOAD: specwright/product/blocker-analysis.md (if exists)
    SCAN: specwright/product/modules/*/blocker-analysis.md (collect all module blockers)
  ...
  ELSE IF specwright/product/product-brief.md EXISTS:
    ...
    LOAD: specwright/product/product-brief.md
    LOAD: specwright/product/roadmap.md (REQUIRED)
    LOAD: specwright/product/blocker-analysis.md (if exists)
...
<blocker_mapping>
  ...
  IF platform project:
    SCAN: specwright/product/modules/*/blocker-analysis.md
...
<file_output>
  LOAD: milestone-plan-template.md (hybrid lookup)
    TRY: specwright/templates/product/milestone-plan-template.md
    FALLBACK: ~/.specwright/templates/product/milestone-plan-template.md

  WRITE to: specwright/product/milestone-plan.md
...
- specwright/product/milestone-plan.md
...
|------|-------------|--------------|
| specwright/product/milestone-plan.md | Complete milestone plan with criteria and contract clauses | Always |
