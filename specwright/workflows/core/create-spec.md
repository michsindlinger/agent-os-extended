...
<delegation>
  ...
  - Architecture Structure: specwright/product/architecture-structure.md (folder structure)
  ...
  - **Skill Index: specwright/team/skill-index.md (for skill selection)**
  ...
  2. FOR EACH story file in stories/ directory:
     ...
     d. FILL IN the following sections:
        ...
        **Relevante Skills:** (NEW - select from skill-index.md)
        ...
        | Skill | Pfad | Grund |
        |-------|------|-------|
        | [skill-name] | specwright/skills/[skill].md | [Why this skill is relevant] |
  ...
  - Reference: specwright/team/skill-index.md (for skill selection)
  ...
  ELSE (stories with incomplete DoR):
    ...
    <user_choice_handling>
      IF choice = "Return to Architect":
        ...
        "Complete all DoR checkboxes for stories in specwright/specs/[spec-name]/stories/
