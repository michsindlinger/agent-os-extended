...
<check_devteam>
  LOAD: specwright/team/agents/*.md (if exists)
...
<report_generation>
  LOAD template: specwright/templates/feasibility/feasibility-report.md
...
<template_lookup>
  PATH: specwright/templates/feasibility/feasibility-report.md

  LOOKUP STRATEGY (Hybrid):
    1. TRY: Read from project (specwright/templates/feasibility/feasibility-report.md)
    2. IF NOT FOUND: Read from global (~/.specwright/templates/feasibility/feasibility-report.md)
...
[IF CAUTION:]
  ...
  Siehe: specwright/feasibility/[name]-feasibility-report.md
...
Report gespeichert: specwright/feasibility/[name]-feasibility-report.md
```
</summary_format>
...
<error_scenarios>
  ...
  <scenario name="tech_stack_missing">
    ...
    <action>
      USE global defaults from ~/.specwright/standards/tech-stack.md
...
|------|-------------|----------|
| feasibility-report.md | Complete analysis report | specwright/feasibility/ |
...
/analyze-feasibility --brief specwright/platform/modules/auth/module-brief.md
