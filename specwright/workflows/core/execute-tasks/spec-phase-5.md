  ...
  IF story-999 exists in kanban.json:
    ...
    IF status = "done":
      ...
      **Note:** Finalization was handled by System Story 999.
      ...
      ### Kanban Status
      - View: specwright/specs/{SELECTED_SPEC}/kanban.json

      ### Handover-Dokumentation
      - **Test-Szenarien:** specwright/specs/{SELECTED_SPEC}/test-scenarios.md
      - **User-Todos:** specwright/specs/{SELECTED_SPEC}/user-todos.md (if exists)
      - **Review Report:** specwright/specs/{SELECTED_SPEC}/review-report.md
...
<step name="generate_test_scenarios">
  ...
  **Create documentation for manual testing or AI-based E2E tests.**
  ...
  <test_scenarios_generation>
    1. READ: All completed stories from specwright/specs/{SELECTED_SPEC}/stories/

    2. CREATE: specwright/specs/{SELECTED_SPEC}/test-scenarios.md
    ...
    OUTPUT: "Test-Szenarien generated: specwright/specs/{SELECTED_SPEC}/test-scenarios.md"
  </test_scenarios_generation>
</step>
...
<step name="finalize_user_todos">
  ...
  **Review and finalize user-todos.md if manual tasks were collected.**
  ...
  <user_todos_finalization>
    ...
    IF EXISTS:
      1. READ: specwright/specs/{SELECTED_SPEC}/user-todos.md
