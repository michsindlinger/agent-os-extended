...
<delegation>
  ...
  - TRY: specwright/templates/platform/module-brief-template.md
  - FALLBACK: ~/.specwright/templates/platform/module-brief-template.md
...
<delegation>
  ...
  7. Write to: specwright/product/architecture/module-dependencies.md

  Templates (hybrid lookup):
  - TRY: specwright/templates/platform/module-dependencies-template.md
  - FALLBACK: ~/.specwright/templates/platform/module-dependencies-template.md"
...
<delegation>
  ...
  5. Get user approval
  6. Write to: specwright/product/architecture/platform-architecture.md

  Templates (hybrid lookup):
  - TRY: specwright/templates/platform/platform-architecture-template.md
  - FALLBACK: ~/.specwright/templates/platform/platform-architecture-template.md"
