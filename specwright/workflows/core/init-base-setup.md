...
## Purpose
Initialize a new project with pre-configured base setups from the specwright-base-setups repository. Provides intelligent template discovery and installation with AI-guided setup validation.
...
1. **Repository Access**: Clone or fetch from `git@github.com:michsindlinger/specwright-base-setups.git`
...
- Maintains Specwright directory structure and conventions
...
- Integration with existing Specwright workflow is seamless
