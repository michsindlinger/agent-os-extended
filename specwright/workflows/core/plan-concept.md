...
<profile_detection>
  ...
  2. ELIF specwright/profile/ exists:
     LOAD latest profile from specwright/profile/
  3. ELIF ~/.specwright/profile/ exists:
     LOAD global profile
  4. ELSE:
...
<date_setup>
  ...
  - output_folder: specwright/concepts/[current_date]-[project_slug]/
</date_setup>
...
<folder_structure>
  CREATE:
  specwright/concepts/[current_date]-[project_slug]/
...
<write_analysis>
  ...
  <template_lookup>
    1. TRY: specwright/templates/concept/concept-analysis-template.md (project)
    2. IF NOT FOUND: ~/.specwright/templates/concept/concept-analysis-template.md (global)
...
<write_research>
  ...
  <template_lookup>
    1. TRY: specwright/templates/concept/domain-research-template.md (project)
    2. IF NOT FOUND: ~/.specwright/templates/concept/domain-research-template.md (global)
    3. IF STILL NOT FOUND: Error - template missing
  </template_lookup>
...
<write_competence_map>
  ...
  <template_lookup>
    1. TRY: specwright/templates/concept/competence-map-template.md (project)
    2. IF NOT FOUND: ~/.specwright/templates/concept/competence-map-template.md (global)
    3. IF STILL NOT FOUND: Error - template missing
  </template_lookup>
...
<proposal_generation>
  ...
  <template_lookup>
    1. TRY: specwright/templates/concept/proposal-concept-template.md (project)
    2. IF NOT FOUND: ~/.specwright/templates/concept/proposal-concept-template.md (global)
    3. IF STILL NOT FOUND: Error - template missing
  </template_lookup>
...
<pitch_generation>
  ...
  <template_lookup>
    1. TRY: specwright/templates/concept/pitch-script-template.md (project)
    2. IF NOT FOUND: ~/.specwright/templates/concept/pitch-script-template.md (global)
    3. IF STILL NOT FOUND: Error - template missing
  </template_lookup>
...
<poc_generation>
  ...
  <template_lookup>
    1. TRY: specwright/templates/concept/poc-plan-template.md (project)
    2. IF NOT FOUND: ~/.specwright/templates/concept/poc-plan-template.md (global)
    3. IF STILL NOT FOUND: Error - template missing
  </template_lookup>
...
<create_overview>
  ...
  <template_lookup>
    1. TRY: specwright/templates/concept/overview-template.md (project)
    2. IF NOT FOUND: ~/.specwright/templates/concept/overview-template.md (global)
    3. IF STILL NOT FOUND: Error - template missing
  </template_lookup>
...
|------|-------------|----------|
| concept-analysis.md | Strukturierte Anfrage-Analyse | specwright/concepts/[date]-[slug]/ |
| domain-research.md | Domain-Recherche-Ergebnisse | specwright/concepts/[date]-[slug]/ |
| competence-map.md | Kompetenz-Mapping mit Fit-Score | specwright/concepts/[date]-[slug]/ |
| proposal-concept.md | Hauptdokument: Konzept/Proposal | specwright/concepts/[date]-[slug]/ |
| pitch-script.md | Pitch- und Interview-Vorbereitung | specwright/concepts/[date]-[slug]/ |
| poc-plan.md | POC-Plan (optional) | specwright/concepts/[date]-[slug]/ |
| overview.md | Index aller Dokumente + Status | specwright/concepts/[date]-[slug]/ |
...
# Alles zusammen
/plan-concept --poc --profile specwright/profile/optimized-profile.md
```
