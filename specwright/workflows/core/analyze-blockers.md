...
<delegation>
  ...
  - Tech Stack: specwright/product/tech-stack.md (if exists)
  - Module Briefs: specwright/product/modules/*/module-brief.md
  - Platform Roadmap: specwright/product/roadmap/platform-roadmap.md (if exists)
  - Module Dependencies: specwright/product/architecture/module-dependencies.md (if exists)
  ...
  6. Write PLATFORM OVERVIEW to: specwright/product/blocker-analysis.md
  7. Write per-module details to: specwright/product/modules/[module-name]/blocker-analysis.md

  Templates (hybrid lookup):
  - TRY: specwright/templates/product/blocker-analysis-template.md
  - FALLBACK: ~/.specwright/templates/product/blocker-analysis-template.md
...
<delegation>
  ...
  - Tech Stack: specwright/product/tech-stack.md (if exists)
  - Roadmap: specwright/product/roadmap.md (if exists)
  - Architecture: specwright/product/architecture-decision.md (if exists)
  ...
  6. Write to: specwright/product/blocker-analysis.md
...
[If platform: Also check per-module analyses in specwright/product/modules/*/blocker-analysis.md]
...
|------|-------------|--------------|
| specwright/product/blocker-analysis.md | Main analysis (or platform overview) | Always |
| specwright/product/modules/[name]/blocker-analysis.md | Per-module analysis | Platform only |
