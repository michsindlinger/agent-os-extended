---
description: Daily Plan Creation Rules for Specwright
globs:
alwaysApply: false
version: 1.2
encoding: UTF-8
...
<existing_plan_check>
  ...
  IF directory_exists:
    <load_existing_items>
      <load_summary>
        READ: .specwright/daily-plans/YYYY-MM-DD/daily-summary.md
...
<directory_structure>
  <base_path>.specwright/daily-plans/YYYY-MM-DD/</base_path>
  <naming>
...
<summary_handling>
  ...
  ELSE:
    <create_new_summary>
      <file_template>
        <path>.specwright/daily-plans/YYYY-MM-DD/daily-summary.md</path>
        <content>
          # Daily Work Plan
...
<for_each_approved_feature>
  <file_template>
    <path>.specwright/daily-plans/YYYY-MM-DD/feature-[KEBAB-CASE].md</path>
    <content>
...
<for_each_approved_bug>
  <file_template>
    <path>.specwright/daily-plans/YYYY-MM-DD/bug-[KEBAB-CASE].md</path>
    <content>
      # Bug: [BUG_TITLE]
...
<for_each_approved_task>
  <file_template>
    <path>.specwright/daily-plans/YYYY-MM-DD/task-[KEBAB-CASE].md</path>
    <content>
      # Task: [TASK_NAME]
...
<confirmation_message>
  IF append_mode == true:
    ...
    Files updated/created in: .specwright/daily-plans/YYYY-MM-DD/
  ...
  ELSE:
    ...
    Files created in: .specwright/daily-plans/YYYY-MM-DD/
