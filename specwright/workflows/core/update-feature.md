---
description: Feature Update Rules for Specwright
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
Use the context-fetcher subagent to identify existing spec folders in .specwright/specs/ to locate the feature that needs updating.

<search_pattern>
  <location>.specwright/specs/</location>
...
<required_reads>
  <spec_md>@specwright/specs/[SELECTED_SPEC]/spec.md</spec_md>
  <spec_lite>@specwright/specs/[SELECTED_SPEC]/spec-lite.md</spec_lite>
  <tasks_md>@specwright/specs/[SELECTED_SPEC]/tasks.md (if exists)</tasks_md>
</required_reads>

<conditional_reads>
  <changelog>@specwright/specs/[SELECTED_SPEC]/changelog.md (if exists)</changelog>
  <changes_folder>@specwright/specs/[SELECTED_SPEC]/changes/ (list contents)</changes_folder>
</conditional_reads>
...
<directory_structure>
  <target>.specwright/specs/[SELECTED_SPEC]/changes/</target>
...
<file_template>
  <header>
    ...
    > Date: [CURRENT_DATE]
    > Related Spec: @specwright/specs/[SELECTED_SPEC]/spec.md
  </header>
...
<changelog_template>
  <header>
    ...
    > Spec Location: @specwright/specs/[SELECTED_SPEC]/spec.md
  </header>
  ...
  <entry_format>
    ...
    **Change File:** @specwright/specs/[SELECTED_SPEC]/changes/[CHANGE_FILE].md
...
<task_template>
  <header>
    ...
    > Change Details: @specwright/specs/[SELECTED_SPEC]/changes/[CHANGE_FILE].md
    > Original Spec: @specwright/specs/[SELECTED_SPEC]/spec.md
  </header>
...
<review_request>
  ...
  - Change Details: @specwright/specs/[SELECTED_SPEC]/changes/[CHANGE_FILE].md
  - Updated Changelog: @specwright/specs/[SELECTED_SPEC]/changelog.md  
  - Implementation Tasks: @specwright/specs/[SELECTED_SPEC]/tasks-[CURRENT_DATE].md
...
<execution_flow>
  IF user_confirms_yes:
    REFERENCE: @~/.specwright/workflows/core/execute-tasks.md
