---
description: Analyze Current B2B Enterprise Application & Install Specwright
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
# Analyze Current B2B Enterprise Application & Install Specwright

## Overview

Install Specwright into an existing B2B enterprise codebase, analyze current application state, compliance posture, and integration capabilities. Builds on plan-b2b-application.md with enterprise-specific considerations.
...
<context_questions>
  ...
  To properly set up Specwright for enterprise development, I need to understand:
...
Execute our B2B enterprise planning flow for installing Specwright in existing enterprise applications.
...
<execution_prompt>
  @~/.specwright/workflows/core/plan-b2b-application.md

  I'm installing Specwright into an existing B2B enterprise application. Here's what I've gathered:
...
<instructions>
  ...
  ALLOW: plan-b2b-application.md to create enhanced .specwright/product/ structure
...
Verify installation completeness and provide clear next steps for the enterprise team to start using Specwright with their existing B2B application codebase.

<verification_checklist>
  - [ ] .specwright/product/ directory created with all 7 files
...
<summary_template>
  ## ✅ Specwright Successfully Installed for B2B Enterprise Application

  I've analyzed your [BUSINESS_APPLICATION_TYPE] codebase and set up Specwright with enterprise documentation that reflects your actual implementation and business requirements.
  ...
  - ✓ Enterprise product documentation in `.specwright/product/`
  ...
  1. Review the generated enterprise documentation in `.specwright/product/`
  ...
  5. Start using Specwright for your next business capability:
     ```
     @~/.specwright/workflows/core/create-spec.md
     ```

  Your B2B enterprise application is now Specwright-enabled! 🚀
</summary_template>
...
<final_checklist>
  <verify>
    ...
    - [ ] Enterprise team can adopt Specwright workflow
  </verify>
</final_checklist>