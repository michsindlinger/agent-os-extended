...
<template_lookup>
  PATH: specwright/templates/openclaw/strategy-document-template.md

  LOOKUP STRATEGY (Hybrid):
    1. TRY: Read from project (specwright/templates/openclaw/strategy-document-template.md)
    2. IF NOT FOUND: Read from global (~/.specwright/templates/openclaw/strategy-document-template.md)
...
3. Determine output path:
   ...
   $OUTPUT_DIR = .specwright/openclaw/strategies/$DATE-$SLUG/
