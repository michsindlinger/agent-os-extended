...
**Store in**: `specwright/specs/YYYY-MM-DD-feature-name/mockups/`
...
**Store in**: `specwright/specs/YYYY-MM-DD-feature-name/wireframes/`
...
**Store in**: `specwright/specs/YYYY-MM-DD-feature-name/screenshots/`
...
**Store in**: `specwright/specs/YYYY-MM-DD-feature-name/design-system/`
...
cp /path/to/mockup.png specwright/specs/YYYY-MM-DD-feature-name/mockups/
```
