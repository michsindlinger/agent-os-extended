...
1. **Integration Requirements laden:**
   ...
   cat agent-os/specs/[SPEC_NAME]/spec.md | grep -A 50 "## Integration Requirements"
   ```
...
**WO:**
- Input: `agent-os/specs/[SPEC_NAME]/spec.md` (Integration Requirements)
- Input: `agent-os/specs/[SPEC_NAME]/implementation-plan.md` (Komponenten-Verbindungen)
