...
- [ ] Code follows project style guide
      (Project: @.agent-os/standards/code-style.md OR Global: @~/.agent-os/standards/code-style.md)
- [ ] Code follows best practices
      (Project: @.agent-os/standards/best-practices.md OR Global: @~/.agent-os/standards/best-practices.md)
