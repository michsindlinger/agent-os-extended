...
- [ ] FILE_EXISTS: agent-os/specs/[SPEC_NAME]/review-report.md
...
4. **Review-Report erstellen:**
   - Speichern unter: `agent-os/specs/[SPEC_NAME]/review-report.md`
...
- Output: `agent-os/specs/[SPEC_NAME]/review-report.md`
...
test -f agent-os/specs/[SPEC_NAME]/review-report.md

# Verify report has content
grep -q "Review Summary" agent-os/specs/[SPEC_NAME]/review-report.md
```
