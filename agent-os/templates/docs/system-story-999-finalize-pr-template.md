...
- [ ] FILE_EXISTS: agent-os/specs/[SPEC_NAME]/test-scenarios.md
- [ ] FILE_EXISTS: agent-os/specs/[SPEC_NAME]/user-todos.md (wenn manuelle Tasks vorhanden)
...
test -f agent-os/specs/[SPEC_NAME]/test-scenarios.md
