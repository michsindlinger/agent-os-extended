...
<!-- Populated during team setup based on documentation needs -->
[SKILLS_LIST]
...
**Product Context:** agent-os/product/product-brief-lite.md
**Tech Stack:** agent-os/product/tech-stack.md
**Documentation Standards:** agent-os/standards/best-practices.md
