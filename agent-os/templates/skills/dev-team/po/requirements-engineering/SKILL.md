...
### Documentation
- Access to `.agent-os/specs/` for detailed specifications
- Access to `.agent-os/product/mission.md` for product vision
...
- [ ] Spec document created at `.agent-os/specs/YYYY-MM-DD-feature-name/`
...
```bash
create-spec  # Generate full specification in .agent-os/specs/
```
