...
<!-- Populated during skill creation based on:
     ...
     - [MCP tool suggestions based on skill domain]
...
### Agent OS Workflows
[WORKFLOW_TOOLS]
<!-- Optional: Related workflows or templates -->
...
1. Standard skill templates don't cover the needed capability
2. Highly specialized domain knowledge required (blockchain, ML, IoT, etc.)
3. Project-specific patterns need to be captured
