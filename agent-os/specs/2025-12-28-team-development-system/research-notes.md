...
**Source**: `agent-os/workflows/validation/validate-market.md` (18 steps, 7 specialists coordinated)
...
**Source**: `agent-os/skills/` (11 existing tech skills + 7 market validation skills)
...
**Source**: `agent-os/config.yml` with `market_validation` section (56 lines)
...
# Installs to ~/.agent-os/ and ~/.claude/

REPO_URL="..."

# Download skills
download_file "$REPO_URL/agent-os/skills/base/testing-best-practices.md" \
  ~/.agent-os/skills/base/testing-best-practices.md "skill"
...
**Source**: `agent-os/templates/market-validation/` (7 templates for validation)
...
**Source**: `agent-os/profiles/` (4 existing profiles)
