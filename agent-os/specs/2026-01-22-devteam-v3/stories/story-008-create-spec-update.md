...
- [ ] FILE_EXISTS: agent-os/templates/docs/story-template.md (aktualisiert)

### Inhalt-Prüfungen

- [ ] NOT_CONTAINS: agent-os/templates/docs/story-template.md enthält "**WER:**"
- [ ] NOT_CONTAINS: agent-os/templates/docs/story-template.md enthält "Relevante Skills"
- [ ] NOT_CONTAINS: agent-os/templates/docs/story-template.md enthält "skill-index.md"
- [ ] CONTAINS: agent-os/templates/docs/story-template.md enthält "**Domain:**"
...
**WO:**
- agent-os/templates/docs/story-template.md (aktualisieren)
...
```bash
# Verify no WER field
! grep -q '^\*\*WER:\*\*' agent-os/templates/docs/story-template.md && echo "No WER OK"

# Verify no Relevante Skills
! grep -q "Relevante Skills" agent-os/templates/docs/story-template.md && echo "No Skills section OK"

# Verify Domain field exists
grep -q '^\*\*Domain:\*\*' agent-os/templates/docs/story-template.md && echo "Domain field OK"
```
