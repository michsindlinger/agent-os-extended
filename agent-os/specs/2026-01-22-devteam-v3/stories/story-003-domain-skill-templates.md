...
Scenario: Domain Skill Index Template ist vollständig
  ...
  Then existiert agent-os/templates/skills/domain/Skill.md
...
Scenario: Domain Process Template ist vollständig
  ...
  Then existiert agent-os/templates/skills/domain/process.md
...
- [ ] FILE_EXISTS: agent-os/templates/skills/domain/Skill.md
- [ ] FILE_EXISTS: agent-os/templates/skills/domain/process.md

### Inhalt-Prüfungen

- [ ] CONTAINS: agent-os/templates/skills/domain/Skill.md enthält "Domain Areas"
- [ ] CONTAINS: agent-os/templates/skills/domain/Skill.md enthält "Self-Updating"
- [ ] CONTAINS: agent-os/templates/skills/domain/process.md enthält "Process Flow"
- [ ] CONTAINS: agent-os/templates/skills/domain/process.md enthält "Business Rules"
- [ ] CONTAINS: agent-os/templates/skills/domain/process.md enthält "Related Code"
...
**WO:**
```
agent-os/templates/skills/domain/
...
test -f agent-os/templates/skills/domain/Skill.md && echo "Skill.md OK"
test -f agent-os/templates/skills/domain/process.md && echo "process.md OK"

# Verify Self-Updating rule
grep -q "Self-Updating" agent-os/templates/skills/domain/Skill.md && echo "Self-Updating OK"

# Verify process.md structure
grep -q "Process Flow" agent-os/templates/skills/domain/process.md && echo "Process Flow OK"
grep -q "Business Rules" agent-os/templates/skills/domain/process.md && echo "Business Rules OK"
```
