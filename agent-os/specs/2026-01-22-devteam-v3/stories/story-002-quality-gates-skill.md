...
Scenario: Quality Gates Skill Template ist vollständig
  ...
  Then existiert agent-os/templates/skills/quality-gates/Skill.md
...
- [ ] FILE_EXISTS: agent-os/templates/skills/quality-gates/Skill.md

### Inhalt-Prüfungen

- [ ] CONTAINS: agent-os/templates/skills/quality-gates/Skill.md enthält "alwaysApply: true"
- [ ] CONTAINS: agent-os/templates/skills/quality-gates/Skill.md enthält "Before Every Commit"
- [ ] CONTAINS: agent-os/templates/skills/quality-gates/Skill.md enthält "Self-Learning Rule"
- [ ] CONTAINS: agent-os/templates/skills/quality-gates/Skill.md enthält "dos-and-donts.md"
...
**WO:**
```
agent-os/templates/skills/quality-gates/
└── Skill.md
```
...
test -f agent-os/templates/skills/quality-gates/Skill.md && echo "OK"

# Verify alwaysApply is true
grep -q "alwaysApply: true" agent-os/templates/skills/quality-gates/Skill.md && echo "alwaysApply OK"

# Verify Self-Learning Rule exists
grep -q "Self-Learning" agent-os/templates/skills/quality-gates/Skill.md && echo "Self-Learning OK"
```
