...
- [ ] FILE_EXISTS: agent-os-ui/config.json
- [ ] FILE_EXISTS: agent-os-ui/src/server/projects.ts
- [ ] FILE_EXISTS: agent-os-ui/ui/src/components/project-selector.ts
...
- [ ] TEST_PASS: cd agent-os-ui && npm test -- --grep "project"
