...
Research and analysis for the spec detailed in @agent-os/specs/2025-12-29-agent-os-manager-gui/spec.md
...
**Agent OS Manager GUI - Desktop Application**

A desktop GUI application for managing Agent OS Extended components with visual editing capabilities:
...
- Global components in ~/.agent-os/ or .claude/
- Project overrides in agent-os/ or .claude/
...
- .claude/skills/ contains symlinks to agent-os/skills/
...
**Must Handle:**
- Global component locations (~/.agent-os/, ~/.claude/)
- Project component locations (agent-os/, .claude/)
- Symlink resolution (.claude/skills/ → agent-os/skills/)
...
- Must detect project root (where agent-os/ exists)
...
- Follow Agent OS tech stack: React + TailwindCSS
...
**Icons:**
- Lucide React (consistent with Agent OS standards)
...
- Q: Should the GUI auto-update global components when Agent OS Extended releases updates?
