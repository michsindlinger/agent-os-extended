...
> Spec: Agent OS Manager GUI
> Created: 2025-12-29
> Research: @agent-os/specs/2025-12-29-agent-os-manager-gui/research-notes.md
> Version: 1.0

## Overview

Desktop GUI application for managing Agent OS Extended components (skills, agents, templates, configuration) with visual distinction between global and project-specific overrides. Targets technical developers who want visual overview and easy editing capabilities.
...
**Workflow**:
1. Developer opens Agent OS Manager GUI
...
7. Writes to agent-os/config.yml
...
- Detect global location: ~/.agent-os/ or agent-os-extended/agent-os/
...
- Or: "Using: ~/.agent-os/skills/base/testing-best-practices.md (global)"
...
Comprehensive research documentation: @agent-os/specs/2025-12-29-agent-os-manager-gui/research-notes.md
...
- [ ] File paths resolve correctly (global ~/.agent-os/ and project agent-os/)
...
- Tasks: @agent-os/specs/2025-12-29-agent-os-manager-gui/tasks.md
- Technical Specification: @agent-os/specs/2025-12-29-agent-os-manager-gui/sub-specs/technical-spec.md
- Research Notes: @agent-os/specs/2025-12-29-agent-os-manager-gui/research-notes.md
