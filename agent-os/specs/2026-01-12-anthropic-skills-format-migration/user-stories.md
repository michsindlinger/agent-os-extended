...
**Datei-Pruefungen:**
- [ ] FILE_EXISTS: agent-os/templates/skills/api-implementation-patterns/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/component-architecture/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/deployment-automation/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/file-organization-patterns/SKILL.md
- [ ] FILE_NOT_EXISTS: agent-os/templates/skills/api-implementation-patterns-template.md
...
**WO:**
- Quell-Dateien: `agent-os/templates/skills/*-template.md`
- Ziel-Ordner: `agent-os/templates/skills/{skill-name}/SKILL.md`
- Zusaetzlich: `agent-os/templates/skills/*.md.template` -> entsprechende Skill-Ordner
...
test -f agent-os/templates/skills/api-implementation-patterns/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/component-architecture/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/deployment-automation/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/file-organization-patterns/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/testing-strategies/SKILL.md && echo "OK" || exit 1
test ! -f agent-os/templates/skills/api-implementation-patterns-template.md && echo "OK" || exit 1
grep -q "name:" agent-os/templates/skills/api-implementation-patterns/SKILL.md && echo "OK" || exit 1
```
...
**Datei-Pruefungen:**
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/frontend/ui-component-architecture/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/frontend/state-management/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/frontend/api-bridge-building/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/frontend/interaction-designing/SKILL.md
- [ ] FILE_NOT_EXISTS: agent-os/templates/skills/dev-team/frontend/ui-component-architecture-template.md
...
**WO:**
- Quell-Dateien: `agent-os/templates/skills/dev-team/frontend/*-template.md`
- Ziel-Ordner: `agent-os/templates/skills/dev-team/frontend/{skill-name}/SKILL.md`
...
```bash
# Auto-Verify Commands - all must exit with 0
test -f agent-os/templates/skills/dev-team/frontend/ui-component-architecture/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/dev-team/frontend/state-management/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/dev-team/frontend/api-bridge-building/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/dev-team/frontend/interaction-designing/SKILL.md && echo "OK" || exit 1
test ! -f agent-os/templates/skills/dev-team/frontend/ui-component-architecture-template.md && echo "OK" || exit 1
grep -qi "component" agent-os/templates/skills/dev-team/frontend/ui-component-architecture/SKILL.md && echo "OK" || exit 1
```
...
**Datei-Pruefungen:**
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/backend/logic-implementing/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/backend/persistence-adapter/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/backend/integration-adapter/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/backend/test-engineering/SKILL.md
- [ ] FILE_NOT_EXISTS: agent-os/templates/skills/dev-team/backend/logic-implementing-template.md
...
**WO:**
- Quell-Dateien: `agent-os/templates/skills/dev-team/backend/*-template.md`
- Ziel-Ordner: `agent-os/templates/skills/dev-team/backend/{skill-name}/SKILL.md`
...
```bash
# Auto-Verify Commands - all must exit with 0
test -f agent-os/templates/skills/dev-team/backend/logic-implementing/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/dev-team/backend/persistence-adapter/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/dev-team/backend/integration-adapter/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/dev-team/backend/test-engineering/SKILL.md && echo "OK" || exit 1
test ! -f agent-os/templates/skills/dev-team/backend/logic-implementing-template.md && echo "OK" || exit 1
grep -q "---" agent-os/templates/skills/dev-team/backend/logic-implementing/SKILL.md && echo "OK" || exit 1
```
...
**Datei-Pruefungen:**
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/architect/pattern-enforcement/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/devops/pipeline-engineering/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/qa/test-strategy/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/po/requirements-engineering/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/dev-team/documenter/changelog-generation/SKILL.md
...
**WO:**
- Quell-Dateien: `agent-os/templates/skills/dev-team/{role}/*-template.md`
- Ziel-Ordner: `agent-os/templates/skills/dev-team/{role}/{skill-name}/SKILL.md`
...
# Auto-Verify Commands - all must exit with 0
# Architect Skills
test -f agent-os/templates/skills/dev-team/architect/pattern-enforcement/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/dev-team/architect/api-designing/SKILL.md && echo "OK" || exit 1
# DevOps Skills
test -f agent-os/templates/skills/dev-team/devops/pipeline-engineering/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/dev-team/devops/infrastructure-provisioning/SKILL.md && echo "OK" || exit 1
# QA Skills
test -f agent-os/templates/skills/dev-team/qa/test-strategy/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/dev-team/qa/test-automation/SKILL.md && echo "OK" || exit 1
# PO Skills
test -f agent-os/templates/skills/dev-team/po/requirements-engineering/SKILL.md && echo "OK" || exit 1
# Documenter Skills
test -f agent-os/templates/skills/dev-team/documenter/changelog-generation/SKILL.md && echo "OK" || exit 1
# Verify old files removed
test ! -f agent-os/templates/skills/dev-team/architect/pattern-enforcement-template.md && echo "OK" || exit 1
# Verify content
grep -qi "pattern" agent-os/templates/skills/dev-team/architect/pattern-enforcement/SKILL.md && echo "OK" || exit 1
```
...
**Datei-Pruefungen:**
- [ ] FILE_EXISTS: agent-os/templates/skills/platform/dependency-management/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/platform/modular-architecture/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/platform/platform-scalability/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/platform/system-integration-patterns/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/orchestration/orchestration/SKILL.md
...
**WO:**
- Quell-Dateien Platform: `agent-os/templates/skills/platform/*-template.md`
- Quell-Dateien Orchestration: `agent-os/templates/skills/orchestration/*-template.md`
- Ziel-Ordner Platform: `agent-os/templates/skills/platform/{skill-name}/SKILL.md`
- Ziel-Ordner Orchestration: `agent-os/templates/skills/orchestration/orchestration/SKILL.md`
...
# Auto-Verify Commands - all must exit with 0
# Platform Skills
test -f agent-os/templates/skills/platform/dependency-management/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/platform/modular-architecture/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/platform/platform-scalability/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/platform/system-integration-patterns/SKILL.md && echo "OK" || exit 1
# Orchestration Skills
test -f agent-os/templates/skills/orchestration/orchestration/SKILL.md && echo "OK" || exit 1
# Verify old files removed
test ! -f agent-os/templates/skills/platform/dependency-management-template.md && echo "OK" || exit 1
test ! -f agent-os/templates/skills/orchestration/orchestration-template.md && echo "OK" || exit 1
# Verify content
grep -qi "dependency" agent-os/templates/skills/platform/dependency-management/SKILL.md && echo "OK" || exit 1
```
...
Als Nutzer von Agent OS mit bestehendem Dev-Team
...
**Datei-Pruefungen:**
- [ ] FILE_EXISTS: agent-os/scripts/migrate-skills-format.sh
- [ ] FILE_EXISTS: agent-os/templates/skills/generic-skill/SKILL.md
- [ ] FILE_EXISTS: agent-os/templates/skills/skill/SKILL.md
...
- [ ] LINT_PASS: shellcheck agent-os/scripts/migrate-skills-format.sh exits with 0
...
**WO:**
- Script-Datei: `agent-os/scripts/migrate-skills-format.sh`
- Generische Skill-Templates: `agent-os/templates/skills/generic-skill/SKILL.md` und `agent-os/templates/skills/skill/SKILL.md`
...
# Auto-Verify Commands - all must exit with 0
# Script existiert
test -f agent-os/scripts/migrate-skills-format.sh && echo "OK" || exit 1
# Script ist ausfuehrbar oder hat shebang
grep -q "#!/bin/bash" agent-os/scripts/migrate-skills-format.sh && echo "OK" || exit 1
# Script referenziert SKILL.md
grep -q "SKILL.md" agent-os/scripts/migrate-skills-format.sh && echo "OK" || exit 1
# Script hat Fehlerbehandlung
grep -qE "(echo|exit)" agent-os/scripts/migrate-skills-format.sh && echo "OK" || exit 1
# Generic skill templates migriert
test -f agent-os/templates/skills/generic-skill/SKILL.md && echo "OK" || exit 1
test -f agent-os/templates/skills/skill/SKILL.md && echo "OK" || exit 1
# Shellcheck (wenn installiert, sonst skip)
command -v shellcheck >/dev/null 2>&1 && shellcheck agent-os/scripts/migrate-skills-format.sh && echo "OK" || echo "SKIP: shellcheck not installed"
```
