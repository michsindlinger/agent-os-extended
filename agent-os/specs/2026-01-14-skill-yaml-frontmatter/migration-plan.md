---
description: Migration plan for adding YAML frontmatter to Agent OS skills
version: 1.0
encoding: UTF-8
---
...
### What Doesn't Work
- DevTeam skill templates in `agent-os/templates/skills/dev-team/*/SKILL.md` have placeholder frontmatter
...
**File**: `agent-os/templates/skills/skill/SKILL.md`
...
**File**: `agent-os/workflows/core/build-development-team.md`
...
**New File**: `agent-os/workflows/skill/utils/globs-mapping.md`
...
2. **Update skill template** (`agent-os/templates/skills/skill/SKILL.md`)
3. **Create globs mapping** (`agent-os/workflows/skill/utils/globs-mapping.md`)
