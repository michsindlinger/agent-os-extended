---
description: Specification for YAML frontmatter in Agent OS skills
version: 1.0
encoding: UTF-8
---
...
This specification defines the required and optional YAML frontmatter fields for Agent OS skills. All skills must have proper YAML frontmatter to be recognized and loaded correctly by Claude Code.
