...
- **Target:** agent-os/docs/story-sizing-guidelines.md
...
- **Assignee:** dev-team__po
- **Target:** agent-os/templates/docs/user-stories-template.md
...
- **Target:** agent-os/workflows/core/create-spec.md (Step 2)
...
- **Assignee:** dev-team__architect
- **Target:** agent-os/workflows/core/create-spec.md (Step 3)
...
- **Assignee:** dev-team__architect
- **Target:** agent-os/workflows/core/execute-tasks.md (Step 5.5)
...
- **Dependencies:** None
- **Assignee:** dev-team__po
- **Target:** agent-os/docs/mcp-setup-guide.md
...
- **Deliverable:** agent-os/docs/story-sizing-guidelines.md

#### ASE-006: MCP-Setup-Guide erstellen
- **Size:** XS (1 SP)
- **Completed:** 2026-01-12
- **Deliverable:** agent-os/docs/mcp-setup-guide.md

#### ASE-002: user-stories-template.md anpassen
- **Size:** S (2 SP)
- **Completed:** 2026-01-12
- **Deliverable:** agent-os/templates/docs/user-stories-template.md
...
- **Size:** S (2 SP)
- **Completed:** 2026-01-12
- **Deliverable:** agent-os/workflows/core/create-spec.md (Step 2)

#### ASE-004: create-spec.md Architect-Phase anpassen
- **Size:** S (3 SP)
- **Completed:** 2026-01-12
- **Deliverable:** agent-os/workflows/core/create-spec.md (Step 3)

#### ASE-005: MCP-Tool-Check in execute-tasks einbauen
- **Size:** S (2 SP)
- **Completed:** 2026-01-12
- **Deliverable:** agent-os/workflows/core/execute-tasks.md (Step 5.5)
