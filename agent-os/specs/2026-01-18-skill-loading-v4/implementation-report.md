...
1. **agent-os/workflows/core/execute-tasks/shared/skill-extraction.md**
   - Version: 3.0 → 4.0
   - Changed: Extract paths only (not content)
   - Removed: Quick Reference extraction logic

2. **agent-os/workflows/core/execute-tasks/spec-phase-3.md**
...
3. **agent-os/workflows/core/execute-tasks/backlog-phase-2.md**
