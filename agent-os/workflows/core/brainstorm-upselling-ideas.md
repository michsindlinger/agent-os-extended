---
description: Brainstorm Upselling & Cross-Selling Ideas for Agent OS Projects
globs:
alwaysApply: false
version: 2.0
encoding: UTF-8
...
<analysis_sequence>
  <check_agent_os_docs>
    IF .agent-os/product/ directory exists:
      READ: .agent-os/product/mission.md (or mission-lite.md)
      READ: .agent-os/product/tech-stack.md
      READ: .agent-os/product/roadmap.md
      READ: .agent-os/product/decisions.md
  ...
  <analyze_codebase>
    IF no Agent OS documentation found:
      ANALYZE:
...
<file_location>.agent-os/business/upselling-ideas-[CURRENT_DATE].md</file_location>
...
<additional_outputs>
  <create_summary>
    ALSO CREATE: .agent-os/business/upselling-summary-[CURRENT_DATE].md
  ...
  <optional_proposals>
    IF user requests:
      CREATE: Individual proposal templates in .agent-os/business/proposals/
