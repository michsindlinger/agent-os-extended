---
description: Instagram Content Plan Creation for Agent OS
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
<prerequisites>
  REQUIRE: @agent-os/marketing/instagram/strategy.md
  IF NOT EXISTS:
...
<load_files>
  - @agent-os/marketing/instagram/strategy.md
  - @agent-os/marketing/instagram/content-pillars.md
  - @agent-os/marketing/instagram/hashtag-sets.md
  - @agent-os/marketing/instagram/posting-schedule.md
...
<file_structure>
  .agent-os/marketing/instagram/content-plans/
...
<review_summary>
  ...
  **Files Created:**
  - Overview: @agent-os/marketing/instagram/content-plans/[FOLDER]/overview.md
