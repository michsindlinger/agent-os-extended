...
**Parameter:**
- `projekt-pfad` (optional): Pfad zum Projekt mit `.agent-os/specs/` Ordner (Standard: aktuelles Verzeichnis)
...
**Aufgabe:** Analysiere alle Spezifikationen im `.agent-os/specs/` Ordner des angegebenen Projekts.
...
**Erstelle:**
`.agent-os/docs/Marketing/Positionierung-[DATUM].md`
...
- `.agent-os/specs/` Ordner mit aussagekräftigen Spezifikationen
