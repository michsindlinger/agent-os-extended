...
|---|-------|----------------|--------|
| 1 | `marketing-system__product-idea-refiner` | Transform vague ideas into structured briefs | `product-brief.md` |
| 2 | `marketing-system__market-researcher` | Competitive intelligence with Perplexity MCP | `competitor-analysis.md` |
| 3 | `marketing-system__product-strategist` | Market positioning, brand story, tone | `market-position.md`, `story.md`, `stil-tone.md` |
| 4 | `marketing-system__content-creator` | Landing page and ad copywriting | Copy for landing page + ads |
| 5 | `marketing-system__seo-expert` | SEO optimization for search visibility | SEO specifications |
| 6 | `marketing-system__landing-page-builder` | Production-ready HTML/CSS/JS | `landing-page/index.html` |
| 7 | `marketing-system__quality-assurance` | Visual validation and QA | QA Report (APPROVE/FIX) |
| 8 | `validation-specialist` | Ad campaign and analytics coordination | `ad-campaigns.md`, `analytics-setup.md`, `validation-plan.md` |
| 9 | `business-analyst` | Metrics analysis and GO/NO-GO decision | `validation-results.md` |
...
**Lookup Order**:
1. **Project-local first**: `projekt/agent-os/templates/documents/`
2. **Global fallback**: `~/.agent-os/templates/documents/`
...
<conditional_logic>
  IF product-brief.md exists in .agent-os/product/:
...
<step number="3" subagent="marketing-system__product-idea-refiner" name="idea_sharpening">

### Step 3: Idea Sharpening (Interactive)

Use the **marketing-system__product-idea-refiner** agent to transform the vague idea into a complete product brief.
...
**Template Location:** `@agent-os/templates/documents/product-brief.md`
...
<step number="5" subagent="marketing-system__market-researcher" name="competitive_analysis">

### Step 5: Competitive Analysis

Delegate to **marketing-system__market-researcher** agent to conduct comprehensive competitive research.

**Input:**
- Product brief: `.agent-os/product/product-brief.md`

**Process:**
1. Receive product-brief.md as context
...
**Template Location:** `@agent-os/templates/documents/competitor-analysis.md`

**Output:** `.agent-os/product/competitor-analysis.md`

**Handoff to:** marketing-system__product-strategist
...
<quality_check>
  ...
  IF incomplete:
    RETURN to marketing-system__market-researcher for completion
  ELSE:
    PROCEED to step 6
</quality_check>
...
<step number="6" subagent="marketing-system__product-strategist" name="market_positioning">

### Step 6: Market Positioning & Brand Story

Delegate to **marketing-system__product-strategist** agent to develop strategic positioning based on competitive analysis.
...
**Template Locations:**
- `@agent-os/templates/documents/market-position.md`
- `@agent-os/templates/documents/story.md`
- `@agent-os/templates/documents/stil-tone.md`

**Output:**
- `.agent-os/product/market-position.md` (positioning statement, messaging pillars)
- `.agent-os/product/story.md` (brand narrative, origin story, StoryBrand elements)
- `.agent-os/product/stil-tone.md` (voice attributes, tone by context, writing style)

**Handoff to:** marketing-system__seo-expert, marketing-system__content-creator
...
<quality_check>
  ...
  IF incomplete:
    RETURN to marketing-system__product-strategist for completion
  ELSE:
    PROCEED to step 7
</quality_check>
...
<conditional_logic>
  IF user provides URL:
    ...
    GENERATE: .agent-os/product/design-system.md
  ...
  ELSE:
    ...
    GENERATE: .agent-os/product/design-system.md with defaults
</conditional_logic>

**Template:** `@agent-os/templates/documents/design-system.md`
**Output:** `.agent-os/product/design-system.md`

</step>

<step number="9" subagent="marketing-system__landing-page-builder" name="landing_page_structure">

### Step 9: Landing Page Structure (Optional)

Delegate to **marketing-system__landing-page-builder** agent to define the modular page structure.
...
**Template:** `@agent-os/templates/documents/landing-page-module-structure.md`
**Output:** `.agent-os/product/landing-page-module-structure.md`
...
<quality_check>
  ...
  IF incomplete:
    RETURN to marketing-system__landing-page-builder for completion
  ELSE:
    PROCEED to step 10
</quality_check>
...
<step number="10" subagent="marketing-system__seo-expert" name="seo_optimization">

### Step 10: SEO Keyword Research & Optimization (Optional)

Delegate to **marketing-system__seo-expert** for keyword research and SEO specifications.
...
**Template:** `@agent-os/templates/documents/seo-keywords.md`
**Output:** `.agent-os/product/seo-keywords.md`

**Handoff to:** marketing-system__content-creator
...
<quality_check>
  ...
  IF incomplete:
    RETURN to marketing-system__seo-expert for completion
  ELSE:
    PROCEED to step 11
</quality_check>
...
<step number="11" subagent="marketing-system__content-creator" name="copywriting">

### Step 11: Content Creation (Optional)

Delegate to **marketing-system__content-creator** agent for landing page and ad copy.
...
- Landing page structure: `.agent-os/product/landing-page-module-structure.md`
- SEO keywords: `.agent-os/product/seo-keywords.md`
...
**Template:** `@agent-os/templates/documents/landingpage-contents.md`
**Output:** `.agent-os/product/landingpage-contents.md`

**Handoff to:** marketing-system__landing-page-builder (Final Build)
...
<quality_check>
  ...
  IF incomplete:
    RETURN to marketing-system__content-creator for completion
  ELSE:
    PROCEED to step 12
</quality_check>
...
<step number="12" subagent="marketing-system__landing-page-builder" name="landing_page_build">

### Step 12: Landing Page Build (Optional)

Delegate to **marketing-system__landing-page-builder** agent for final HTML generation.

**Input:**
- Landing page structure: `.agent-os/product/landing-page-module-structure.md`
- Landing page content: `.agent-os/product/landingpage-contents.md`
- SEO keywords: `.agent-os/product/seo-keywords.md`
- Design system: `.agent-os/product/design-system.md`
...
**Output:** `.agent-os/market-validation/[DATE]-[product]/landing-page/index.html`

**Handoff to:** marketing-system__quality-assurance

</step>

<step number="13" subagent="marketing-system__quality-assurance" name="quality_assurance">

### Step 13: Quality Assurance (Optional)

Delegate to **marketing-system__quality-assurance** agent for visual validation.

**Input:**
- Landing page: `.agent-os/market-validation/[DATE]-[product]/landing-page/index.html`
- Design system: `.agent-os/product/design-system.md`
- Landing page structure: `.agent-os/product/landing-page-module-structure.md`
...
**Output:** QA Report with APPROVED or NEEDS_FIXES status

<conditional_logic>
  IF QA Report status = APPROVED:
    PROCEED to step 14
  ELIF QA Report status = NEEDS_FIXES:
    RETURN to marketing-system__landing-page-builder with specific fixes
    AFTER fixes: RE-RUN step 13
</conditional_logic>

**Handoff to:** User decision gate (if approved)
...
<step number="14" subagent="validation-specialist" name="campaign_planning">

### Step 14: Campaign Planning (Optional - requires user opt-in from Step 13b)

Ask user for budget and timeline, then delegate to **validation-specialist** agent.
...
- Ad copy from marketing-system__content-creator
...
**Handoff to:** User (for campaign execution)
...
<step number="16" subagent="business-analyst" name="go_nogo_decision">

### Step 16: GO/NO-GO Decision

Delegate to **business-analyst** agent for data-driven decision.
...
- Validation plan: `.agent-os/market-validation/[DATE]-[product]/validation-plan.md`
- Competitor analysis: `.agent-os/product/competitor-analysis.md`
...
**Output:** `.agent-os/market-validation/[DATE]-[product]/validation-results.md`
...
All files are in .agent-os/product/ and .agent-os/market-validation/
```
...
### QA Gate
- After landing page generation (Step 13) - marketing-system__quality-assurance validates
...
### Template Usage
All outputs use templates from `@agent-os/templates/documents/`

### Agent Handoff Chain

```
marketing-system__product-idea-refiner
         ↓ (product-brief.md)
marketing-system__market-researcher
         ↓ (competitor-analysis.md)
marketing-system__product-strategist
...
design-system-extractor (skill)
         ↓ (design-system.md)
marketing-system__landing-page-builder (Structure)
         ↓ (landing-page-module-structure.md)
marketing-system__seo-expert
         ↓ (seo-keywords.md)
marketing-system__content-creator
         ↓ (landingpage-contents.md)
marketing-system__landing-page-builder (Final Build)
         ↓ (index.html)
marketing-system__quality-assurance
         ↓ (QA Report: APPROVED)
         ↓
