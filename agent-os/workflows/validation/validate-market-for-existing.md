...
**Process:**
1. If .agent-os/product/ exists with other files:
   - Analyze tech-stack.md, roadmap.md for context
   - Ask user about product purpose and target users
2. If no Agent OS installed:
   - Recommend running /analyze-product first
...
Use product-strategist to refine and generate product-brief.md.
...
<step number="3" subagent="market-researcher" name="competitive_analysis">
...
2. Use Perplexity MCP for competitor identification
...
**Template:** `@agent-os/templates/documents/competitor-analysis.md`
...
<step number="4" subagent="market-researcher" name="market_positioning">
...
**Process:**
1. Analyze competitor-analysis.md
...
**Template:** `@agent-os/templates/documents/market-position.md`
**Output:** `.agent-os/product/market-position.md`
