...
2. **Mockups Available**:
   ```
   agent-os/specs/YYYY-MM-DD-feature-name/mockups/
   ```
...
- agent-os/specs/2025-12-22-invoice-export/mockups/export-button.png
- agent-os/specs/2025-12-22-invoice-export/mockups/export-modal.png
```
...
use MCP to:
  ...
  3. Store in agent-os/specs/.../screenshots/
```
...
**File**: `agent-os/specs/YYYY-MM-DD-feature-name/visual-verification-report.md`
...
Enable visual verification in `agent-os/config.yml`:
