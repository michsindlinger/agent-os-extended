...
<instructions>
  ACTION: Try detection sources
    ...
    PRIORITY_1: agent-os/config.yml
...
<instructions>
  ...
  FOR each agent IN agents_to_create:
    ACTION: Load template
      template_path = "@agent-os/templates/team-development/agents/{agent}-template.md"

      IF agent == "backend-dev":
        READ: @agent-os/templates/team-development/agents/backend-dev-template.md
      ELSE IF agent == "frontend-dev":
        READ: @agent-os/templates/team-development/agents/frontend-dev-template.md
      ELSE IF agent == "qa-specialist":
        READ: @agent-os/templates/team-development/agents/qa-specialist-template.md
      ELSE IF agent == "devops-specialist":
        READ: @agent-os/templates/team-development/agents/devops-specialist-template.md
...
<instructions>
  DISPLAY: Success message
    ...
    3. Enable Team Development System in agent-os/config.yml:
       team_system:
         enabled: true
