...
**What This Installs**:
- 2 skills → `agent-os/skills/base/`
  - `testing-best-practices.md`
  - `devops-patterns.md`
- 12 templates → `agent-os/templates/team-development/`
  - 4 backend templates
...
**What This Does**:
- Creates `agent-os/templates/team-development/` (for overrides)
- Creates `.claude/agents/` (for overrides)
- Adds `team_system` section to `agent-os/config.yml`
...
ls agent-os/skills/base/testing-best-practices.md
ls agent-os/templates/team-development/backend/api-spec.md

# Check project setup
cat agent-os/config.yml | grep team_system
```
...
team_system:
  ...
  lookup_order:
    - project  # Check agent-os/ and .claude/ in project
...
```
agent-os/templates/team-development/backend/api-spec.md
```
...
cp agent-os/templates/team-development/backend/api-spec.md \
   agent-os/templates/team-development/backend/

# Customize for this project
vim agent-os/templates/team-development/backend/api-spec.md
# Add: GraphQL schema section, custom pagination format

# Next time backend-dev runs in THIS project:
# Uses: projekt/agent-os/templates/team-development/backend/api-spec.md
```
...
```yaml
# agent-os/config.yml (project-specific)
team_system:
  specialists:
    backend_dev:
...
# Recreate symlinks
ln -sf agent-os/skills/base/testing-best-practices.md \
...
**A**: Yes! Configure in project's `agent-os/config.yml`:
```yaml
team_system:
  specialists:
    backend_dev:
...
```
Co-Authored-By: backend-dev <backend-dev@agent-os>
Co-Authored-By: frontend-dev <frontend-dev@agent-os>
Co-Authored-By: qa-specialist <qa-specialist@agent-os>
```
...
- **Spec**: `agent-os/specs/2025-12-28-team-development-system/spec.md`
- **Main README**: `README.md` (Team Development System section)
- **Config**: `agent-os/config.yml` (team_system section)
- **Execute Tasks**: `agent-os/workflows/core/execute-tasks.md` (routing logic)
