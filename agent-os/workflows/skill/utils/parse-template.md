...
<template_selection>
  SKILL_TYPE_MAPPING:
    api: "@agent-os/templates/skills/api-patterns.md.template"
    component: "@agent-os/templates/skills/component-patterns.md.template"
    testing: "@agent-os/templates/skills/testing-patterns.md.template"
    deployment: "@agent-os/templates/skills/deployment-patterns.md.template"
