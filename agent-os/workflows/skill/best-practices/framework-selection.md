...
<detection_strategy>
  IF Mode B requested:
    TRY: Framework detection using existing utilities
      LOAD: @agent-os/workflows/skill/utils/detect-backend.md (if api)
      LOAD: @agent-os/workflows/skill/utils/detect-frontend.md (if component)
      LOAD: @agent-os/workflows/skill/utils/detect-testing.md (if testing)
      LOAD: @agent-os/workflows/skill/utils/detect-cicd.md (if deployment)
...
<best_practices_loading>
  ...
  SPRING_BOOT:
    LOAD: @agent-os/workflows/skill/validation/best-practices/spring-boot.md
    INCLUDE:
  ...
  EXPRESS:
    LOAD: @agent-os/workflows/skill/validation/best-practices/express.md
    INCLUDE:
  ...
  REACT:
    LOAD: @agent-os/workflows/skill/validation/best-practices/react.md
    INCLUDE:
  ...
  ANGULAR:
    LOAD: @agent-os/workflows/skill/validation/best-practices/angular.md
    INCLUDE:
  ...
  PLAYWRIGHT:
    LOAD: @agent-os/workflows/skill/validation/best-practices/playwright.md
    INCLUDE:
  ...
  GITHUB_ACTIONS:
    LOAD: @agent-os/workflows/skill/validation/best-practices/github-actions.md
    INCLUDE:
...
<output>
  {
    ...
    best_practices_path: "@agent-os/workflows/skill/validation/best-practices/{framework}.md"
  }
</output>
...
- `@agent-os/workflows/skill/utils/detect-backend.md`
- `@agent-os/workflows/skill/utils/detect-frontend.md`
- `@agent-os/workflows/skill/utils/detect-testing.md`
- `@agent-os/workflows/skill/utils/detect-cicd.md`
- `@agent-os/workflows/skill/validation/best-practices/*.md`
