...
- `@agent-os/workflows/skill/validation/generate-improvements.md`
- `@agent-os/workflows/skill/validation/create-report.md`
- `@agent-os/workflows/skill/utils/extract-patterns.md`
