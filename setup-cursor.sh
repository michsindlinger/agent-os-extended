...
create_mdc_file "$REPO_URL/commands/plan-gift-book.md" ".cursor/rules/plan-gift-book.mdc"
...
create_mdc_file "$REPO_URL/commands/brainstorm-upselling-ideas.md" ".cursor/rules/brainstorm-upselling-ideas.mdc"
create_mdc_file "$REPO_URL/commands/develop-positioning.md" ".cursor/rules/develop-positioning.mdc"
