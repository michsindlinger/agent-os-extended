...
if [[ ! -d "standards" ]] || [[ ! -d "instructions" ]]; then
...
download_file "$REPO_URL/commands/plan-product.md" "commands/plan-product.md"
download_file "$REPO_URL/commands/create-spec.md" "commands/create-spec.md"
download_file "$REPO_URL/commands/execute-tasks.md" "commands/execute-tasks.md"
download_file "$REPO_URL/commands/analyze-product.md" "commands/analyze-product.md"

# Download agent files
echo ""
echo "Setting up agents..."
download_file "$REPO_URL/agents/test-runner.md" "agents/test-runner.md"
download_file "$REPO_URL/agents/context-fetcher.md" "agents/context-fetcher.md"
download_file "$REPO_URL/agents/git-workflow.md" "agents/git-workflow.md"
download_file "$REPO_URL/agents/file-creator.md" "agents/file-creator.md"
download_file "$REPO_URL/agents/date-checker.md" "agents/date-checker.md"

echo ""
echo "✅ Claude Code setup complete!"
echo ""
echo "Project structure created:"
echo "  commands/           - Claude Code commands"
echo "  agents/            - Claude Code agents"
echo ""
