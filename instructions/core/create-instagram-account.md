---
description: Instagram Account Strategy Creation for Agent OS
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
<review_request>
  ...
  - Main Strategy: @.agent-os/marketing/instagram/strategy.md
  - Content Pillars: @.agent-os/marketing/instagram/content-pillars.md
  - Hashtag Sets: @.agent-os/marketing/instagram/hashtag-sets.md
  - Posting Schedule: @.agent-os/marketing/instagram/posting-schedule.md
  - KPIs: @.agent-os/marketing/instagram/kpis.md
...
<standards>
  <follow>
    - @.agent-os/product/mission.md for brand alignment
