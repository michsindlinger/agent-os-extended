...
Refer to the instructions located in @specwright/workflows/openclaw/openclaw-strategy.md
...
**Deliverables:**
- Strategy Document (`.specwright/openclaw/strategies/[YYYY-MM-DD]-[goal-slug]/strategy-document.md`)
  - Executive Summary
