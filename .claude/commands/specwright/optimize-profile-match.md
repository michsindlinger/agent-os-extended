...
Refer to the instructions located in specwright/workflows/core/optimize-profile-phase2.md

**Voraussetzung:**
- Phase 1 (`/optimize-profile`) muss bereits durchgeführt sein
- Requirements-Analyse muss in `.specwright/profile-optimization/[date-project]/` existieren
