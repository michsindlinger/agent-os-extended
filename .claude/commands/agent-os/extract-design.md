...
Refer to the instructions located in @agent-os/workflows/design/extract-design.md
...
**Location**: `agent-os/skills/marketing/design-system-extractor.md`
...
**Requires**:
- `design-system-extractor.md` skill (agent-os/skills/marketing/)
