...
echo "  ~/.specwright/          (skills, templates, workflows)"
...
mkdir -p ~/.specwright/skills/product
...
download_file "$REPO_URL/specwright/skills/product/product-strategy-patterns.md" \
  ~/.specwright/skills/product/product-strategy-patterns.md "skill"

download_file "$REPO_URL/specwright/skills/business/market-research-best-practices.md" \
  ~/.specwright/skills/business/market-research-best-practices.md "skill"

download_file "$REPO_URL/specwright/skills/business/business-analysis-methods.md" \
  ~/.specwright/skills/business/business-analysis-methods.md "skill"

download_file "$REPO_URL/specwright/skills/business/validation-strategies.md" \
  ~/.specwright/skills/business/validation-strategies.md "skill"

download_file "$REPO_URL/specwright/skills/marketing/content-writing-best-practices.md" \
  ~/.specwright/skills/marketing/content-writing-best-practices.md "skill"

download_file "$REPO_URL/specwright/skills/marketing/seo-optimization-patterns.md" \
  ~/.specwright/skills/marketing/seo-optimization-patterns.md "skill"

download_file "$REPO_URL/specwright/skills/marketing/copywriting-style.md" \
  ~/.specwright/skills/marketing/copywriting-style.md "skill"
...
if [[ -d ~/.specwright/skills ]]; then
    mkdir -p ~/.claude/skills

    # Market validation skills
    ln -sf ~/.specwright/skills/product/product-strategy-patterns.md \
      ~/.claude/skills/product-strategy-patterns.md

    ln -sf ~/.specwright/skills/business/market-research-best-practices.md \
      ~/.claude/skills/market-research-best-practices.md

    ln -sf ~/.specwright/skills/business/business-analysis-methods.md \
      ~/.claude/skills/business-analysis-methods.md

    ln -sf ~/.specwright/skills/business/validation-strategies.md \
      ~/.claude/skills/validation-strategies.md

    ln -sf ~/.specwright/skills/marketing/content-writing-best-practices.md \
      ~/.claude/skills/content-writing-best-practices.md

    ln -sf ~/.specwright/skills/marketing/seo-optimization-patterns.md \
      ~/.claude/skills/seo-optimization-patterns.md

    ln -sf ~/.specwright/skills/marketing/copywriting-style.md \
      ~/.claude/skills/copywriting-style.md

    echo "✓ Created 7 skill symlinks in ~/.claude/skills/"
else
    echo "⚠ Skills directory not found (expected at ~/.specwright/skills/)"
fi
...
echo ""
echo "Installed to:"
echo "  ~/.specwright/skills/product/        - Product strategy skill"
echo "  ~/.specwright/skills/business/       - 3 business skills"
echo "  ~/.specwright/skills/marketing/      - 2 marketing skills"
echo "  ~/.specwright/templates/market-validation/  - 7 templates"
echo "  ~/.specwright/workflows/validation/  - validate-market workflow"
echo "  ~/.claude/agents/                  - 7 specialist agents"
echo "  ~/.claude/commands/specwright/       - /validate-market command"
...
echo "  1. Copy component from ~/.specwright/ to projekt/specwright/"
...
echo "  mkdir -p projekt/specwright/market-validation/"
...
echo "  4. Results saved to projekt/specwright/market-validation/"
echo ""
echo "For complete guide, see: ~/.specwright/workflows/validation/README.md"
